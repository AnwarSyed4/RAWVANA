...
public class ActivityMain extends FragmentActivity {
    ...
    private void setUP() {
        try {
            ...
            menuImagesList.add(R.drawable.shopping);
            menuImagesList.add(R.drawable.favorte);
            menuImagesList.add(R.drawable.more);
            menuImagesList.add(R.drawable.about);
            //
            menuActiveImagesList = new ArrayList<>();
            menuActiveImagesList.add(R.drawable.recipe_a);
            menuActiveImagesList.add(R.drawable.shop_a);
            menuActiveImagesList.add(R.drawable.fav_a);
            menuActiveImagesList.add(R.drawable.more_a);
            menuActiveImagesList.add(R.drawable.info_a);
            //
